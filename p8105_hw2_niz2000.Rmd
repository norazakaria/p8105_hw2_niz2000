...
Trash_Wheel_Data
```
The new 2019 version of Mr. Trash Wheel data was used for cleaning and analyses. All non-data entries and rows without dumpster-specific data were omited, the number of sports balls was converted to an integer variable, and reasonable varaible names were used,such as "and.
