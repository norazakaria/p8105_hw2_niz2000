...
In the pols dataset the month variable was broken into “year,” “month,”
and “day” integer variables, and the month number was replaced with the
name (i.e. the name Jan is displayed compared to the integer 1). A new
...
In the snp dataset, the month number was replaced with the month name,
and arranged according with “year” and “month” as the leading columns.
...
variables across the unemployment, pols, and snp datasets.
